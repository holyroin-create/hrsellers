...
export const COVERS: Record<string, Cover> = {
  ...
  'antidumping-duties': {
    kind: 'ledger',
    label: 'Why AD/CVD is different',
    labelShort: 'AD/CVD',
    figure: 'Not in the schedule',
    caption: 'Product and country specific, often company specific.',
    rows: [
      { k: 'Found via HTS code', v: 'no', tone: 'cost' },
      { k: 'Rate ceiling', v: 'none', tone: 'cost' },
      { k: 'Informal entry', v: 'unavailable', tone: 'cost' },
    ],
    stamp: 'Check before sourcing \u00b7 the docket is reported as expanding',
    stampShort: 'Check first',
    tone: 'cost',
  },
  ...
  'buyer-seller-messaging': {
    kind: 'ledger',
    label: 'What gets a message blocked',
    labelShort: 'Blocked content',
    figure: 'Even the name',
    caption: 'AI scans every message. Personalisation is not permitted.',
    rows: [
      { k: 'Buyer first name', v: 'blocked', tone: 'cost' },
      { k: 'Emojis, links, incentives', v: 'blocked', tone: 'cost' },
      { k: 'Request a Review button', v: 'sanctioned', tone: 'gain' },
    ],
    stamp: '30-day window \u00b7 order ID \u00b7 buyer\u2019s language',
    stampShort: '30-day window',
    tone: 'cost',
  },
  'subscribe-and-save': {
    kind: 'range',
  ...
  'tariff-stack-2026': {
    kind: 'range',
    label: 'Reported effective rates, common categories',
    labelShort: 'Effective rate',
    figure: '20–30%+',
    caption: 'Four layers on one entry. Only one is in the schedule.',
    unit: '%',
    lo: 20,
    hi: 30,
    mid: 20,
    ...
    hiTag: 'common high',
    midTag: 'lower',
    stamp: 'Some categories reported far higher \u00b7 check your own code',
    stampShort: 'Check your code',
    tone: 'cost',
  },
  'product-inserts': {
    kind: 'ledger',
    label: 'What an insert may and may not say',
    labelShort: 'Insert rules',
    figure: 'Separate them',
    caption: 'Support and review mention never in the same sentence.',
    rows: [
      { k: 'Setup help, support', v: 'allowed', tone: 'gain' },
      { k: 'Ask for a positive review', v: 'prohibited', tone: 'cost' },
      { k: 'Contact us before reviewing', v: 'prohibited', tone: 'cost' },
    ],
    stamp: 'Supplier packaging with review language counts too',
    stampShort: 'Check the factory',
    tone: 'cost',
  },
  ...
  'qc-inspections': {
    kind: 'range',
    label: 'Third-party inspection, per man-day',
    labelShort: 'Inspection cost',
    figure: '$149–$400',
    caption: 'Against a rejected container, which costs the container.',
    unit: '$',
    lo: 149,
    hi: 400,
    mid: 149,
    ...
    hiTag: 'highest',
    midTag: 'lowest',
    stamp: 'PSI recommended above $10,000 order value',
    stampShort: 'Above $10k',
    tone: 'gain',
  },
  ...
  'section-321-repeal-2027': {
    kind: 'timeline',
    label: 'From executive action to statute',
    labelShort: 'De minimis path',
    figure: '1 Jul 2027',
    caption: 'The date reversion stops being possible.',
    points: [
      { x: 0.05, date: '2 May 2025', note: 'China origin' },
      { x: 0.3, date: '29 Aug 2025', note: 'all origins' },
      { x: 0.58, date: '24 Jun 2026', note: 'regulation' },
      { x: 0.94, date: '1 Jul 2027', note: 'repeal' },
    ],
    stamp: 'A statute needs new legislation to reverse',
    stampShort: 'Statutory',
    tone: 'cost',
  },
  ...
  'first-sale-valuation': {
    kind: 'range',
    label: 'Reported reduction in the dutiable base',
    labelShort: 'First sale saving',
    figure: '15–25%',
    caption: 'Of the value, not the rate. It compounds with everything.',
    unit: '%',
    lo: 15,
    hi: 25,
    mid: 15,
    ...
    hiTag: 'upper',
    midTag: 'lower',
    stamp: 'Last Sale Valuation Act introduced 11 Feb 2026',
    stampShort: 'Bill pending',
    tone: 'gain',
  },
  'amazon-renewed': {
    kind: 'range',
    label: 'Invoice threshold to enter Renewed',
    labelShort: 'Entry threshold',
    figure: '$50k – $2.5m',
    caption: 'General, and Apple. Both in the window before applying.',
    unit: '$',
    lo: 50000,
    hi: 2500000,
    mid: 50000,
    ...
    hiTag: 'Apple',
    midTag: 'general',
    stamp: 'ODR 0.8% \u00b7 90-day warranty you fund',
    stampShort: 'ODR 0.8%',
    tone: 'cost',
  },
  ...
  'duty-drawback': {
    kind: 'ledger',
    label: 'Where drawback reaches a seller',
    labelShort: 'Who qualifies',
    figure: 'Up to 99%',
    caption: 'Refund on duty paid for goods later exported.',
    rows: [
      { k: 'Cross-border fulfilment', v: 'qualifies', tone: 'gain' },
      { k: 'Exported returns', v: 'qualifies', tone: 'gain' },
      { k: 'US-only sales', v: 'no', tone: 'cost' },
    ],
    stamp: 'Described as underutilised by exporting importers',
    stampShort: 'Underclaimed',
    tone: 'gain',
  },
  'prior-disclosure-protests': {
    kind: 'timeline',
    label: 'The window on a liquidated entry',
    labelShort: 'Protest window',
    figure: '180 days',
    caption: 'Per entry, from its own liquidation date.',
    points: [
      { x: 0.05, date: 'Entry', note: 'filed' },
      { x: 0.4, date: 'Liquidation', note: 'clock starts' },
      { x: 0.92, date: '+180 days', note: 'window closes' },
    ],
    stamp: 'No account-level deadline \u00b7 no notification',
    stampShort: 'Expires quietly',
    tone: 'cost',
  },
  ...
  'supplier-payment-terms': {
    kind: 'timeline',
    label: 'The sequence that keeps leverage',
    labelShort: 'Payment order',
    figure: 'Inspect, pay, ship',
    caption: 'Reverse two steps and you are negotiating a refund.',
    points: [
      { x: 0.04, date: 'Deposit', note: 'production starts' },
      { x: 0.36, date: 'DUPRO', note: 'first runs' },
      { x: 0.64, date: 'PSI', note: 'before payment' },
      { x: 0.88, date: 'Balance', note: 'then ship' },
    ],
    stamp: 'Escrow until three clean orders',
    stampShort: 'Escrow first',
    tone: 'cost',
  },
  ...
  'customs-bonds': {
    kind: 'ledger',
    label: 'When a bond is required',
    labelShort: 'Bond required',
    figure: 'Formal entries',
    caption: 'The de minimis suspension made most sellers importers of record.',
    rows: [
      { k: 'Formal entry', v: 'required', tone: 'cost' },
      { k: 'Informal \u2264 $2,500', v: 'may be', tone: 'cost' },
      { k: 'Continuous bond', v: '~10% of duty', tone: 'neutral' },
    ],
    stamp: 'Sizing scales with duty \u00b7 duty rose sharply',
    stampShort: 'Check the amount',
    tone: 'cost',
  },
  'tariff-engineering-design': {
    kind: 'cliff',
    label: 'Where the legal line sits',
    labelShort: 'Legal line',
    figure: 'Product / paperwork',
    caption: 'Change what you import, not what you say about it.',
    before: 'engineering',
    after: 'fraud',
    dropAt: 0.5,
    marks: [
      { x: 0.5, date: 'The line', note: 'product vs description' },
    ],
    stamp: 'HTS 2026 edition published 31 Dec 2025 \u00b7 Revision 4 by 25 Feb',
    stampShort: 'Schedule moves',
    tone: 'cost',
  },
  ...
  'packaging-design-fba': {
    kind: 'ledger',
    label: 'What packaging decides',
    labelShort: 'Packaging',
    figure: 'Six fees',
    caption: 'All fixed at tooling. All charged for years.',
    rows: [
      { k: 'Cubic feet \u2192 storage', v: 'monthly', tone: 'cost' },
      { k: 'Size tier \u2192 fulfilment', v: 'per unit', tone: 'cost' },
      { k: 'Durability \u2192 SIPP', v: 'eligibility', tone: 'gain' },
    ],
    stamp: '0.222 vs 0.556 cu ft on the same product',
    stampShort: '60% difference',
    tone: 'cost',
  },
  'seller-financing': {
    kind: 'range',
  ...
  'annual-operating-calendar': {
    kind: 'timeline',
    label: 'The dates that cannot be caught up',
    labelShort: 'Fixed dates',
    figure: '2 min daily',
    caption: 'Plus an hour monthly and a handful of fixed deadlines.',
    points: [
      { x: 0.06, date: '5 Sep', note: 'deal deadline' },
      { x: 0.36, date: '30 Sep', note: 'inventory fix' },
      { x: 0.6, date: '15 Oct', note: 'peak fees' },
      { x: 0.94, date: '14 Jan', note: 'peak ends' },
    ],
    stamp: 'Two weeks apart \u00b7 between them they decide Q4',
    stampShort: 'Two weeks apart',
    tone: 'gain',
  },
  'order-defect-rate': {
    kind: 'range',
  ...
  'review-manipulation-risk': {
    kind: 'ledger',
    label: 'Who can trigger a flag',
    labelShort: 'Trigger sources',
    figure: 'Mostly not you',
    caption: 'Five of six named triggers are somebody else\u2019s action.',
    rows: [
      { k: 'Supplier packaging', v: 'triggers', tone: 'cost' },
      { k: 'Agency or VA template', v: 'triggers', tone: 'cost' },
      { k: 'Organic review spike', v: 'triggers', tone: 'cost' },
    ],
    stamp: 'Notice names no reviews, no messages, no service',
    stampShort: 'Diagnose it yourself',
    tone: 'cost',
  },
  ...
  'country-of-origin-sourcing': {
    kind: 'ledger',
    label: 'What changes country of origin',
    labelShort: 'Origin test',
    figure: 'Transformation',
    caption: 'Where it was made, not where it shipped from.',
    rows: [
      { k: 'Real manufacturing', v: 'qualifies', tone: 'gain' },
      { k: 'Repackaging, relabelling', v: 'no', tone: 'cost' },
      { k: 'Simple final assembly', v: 'no', tone: 'cost' },
    ],
    stamp: 'Routing without transformation reported as fraud',
    stampShort: 'Not routing',
    tone: 'cost',
  },
  'foreign-trade-zones': {
    kind: 'ledger',
    label: 'What an FTZ actually does',
    labelShort: 'FTZ mechanisms',
    figure: 'Three levers',
    caption: 'Inside the country, outside customs territory.',
    rows: [
      { k: 'Duty deferral', v: 'cash flow', tone: 'gain' },
      { k: 'Re-export', v: 'no duty', tone: 'gain' },
      { k: 'Inverted tariff', v: 'lower rate', tone: 'gain' },
    ],
    stamp: 'A volume decision \u00b7 third-party zones are the usable version',
    stampShort: 'Volume decision',
    tone: 'gain',
  },
  'listing-disappeared': {
    kind: 'timeline',
  ...
  'origin-marking-requirements': {
    kind: 'range',
    label: 'Marking duty on unmarked goods',
    labelShort: 'Marking duty',
    figure: '+10%',
    caption: 'Ad valorem, on top of every other duty.',
    unit: '%',
    lo: 0,
    hi: 10,
    mid: 0,
    ...
    hiTag: 'unmarked',
    midTag: 'compliant',
    stamp: '19 USC 1304 \u00b7 CBP may also refuse entry',
    stampShort: '19 USC 1304',
    tone: 'cost',
  },
  ...
  'sourcing-agents': {
    kind: 'ledger',
    label: 'The question to ask an agent',
    labelShort: 'Agent test',
    figure: 'How are you paid?',
    caption: 'If both sides pay them, you know whose interests align.',
    rows: [
      { k: 'Fee on order value', v: '3\u201310%', tone: 'neutral' },
      { k: 'Factory commission too?', v: 'ask', tone: 'cost' },
      { k: 'Agent-run inspection', v: 'not independent', tone: 'cost' },
    ],
    stamp: 'Selecting the factory and inspecting it is checking own work',
    stampShort: 'Separate the roles',
    tone: 'cost',
  },
