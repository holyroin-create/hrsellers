...
export const MARKETPLACES: Marketplace[] = [
  ...
  /* ------------------------------------------------------------------ */
  {
    ...
    headline: [
      ...
      { k: 'Referral fee', v: '8% of most non-food US categories', note: 'Raised from 6% on 4 August 2026 per recent reporting; beauty reported above 8%, select jewellery below. Several published guides still state 6% — confirm in your own settlement' },
    ...
    contested: [
      { claim: 'Referral rate', detail: 'Recent reporting dates an increase to 8% for most non-food categories to 4 August 2026, months after the 1.8% promotional rate ended in January. Several guides still publish 6%. Treat 8% as the working figure and confirm against your own settlement statement.' },
    ...
    againstIt: [
      ...
      'Thin-margin goods — an 8% fee plus a 15% commission is nearly a quarter of the sale price before fulfilment',
