...
seoTitle: "Sourcing Agents: Why the Selector Should Not Be the Inspector"
...
<Figure value="3–10%" kind="cost" source="Sourcing agent fee range, 2026, checked September 5, 2026">
 The range for transparent agent fees as a share of order value. The published guidance treats fee transparency as a qualifying criterion rather than a negotiating point.
</Figure>
...
<Faq items={[
 { q: "What does a sourcing agent cost?", a: "At roughly 3% to 10% of order value where fees are transparent. The more important question is whether they also take commission from the factory, which changes whose interests they serve." },
 ...
 { q: "When should I go direct?", a: "A stable single-supplier relationship you have run for years, simple standardized products, and any case where the 3% to 10% fee exceeds the price, quality or error saving the agent produces." },
...
<Sources items={[
  { title: 'Alibaba.com Trade Assurance and Verified Supplier program terms (what the platform verifies and what it does not)', publisher: 'Alibaba.com', accessed: '2026-09-05' },
 ...
 { title: 'QC inspection in China (orders handled by a buyer-side sourcing agent having inspection built in rather than skipped; independent third-party firms as the norm for PSI)', publisher: 'Stellar Chinese', href: 'https://www.stellarchinese.com/qc-inspection-in-china/', accessed: '2026-09-05' },
 { title: 'How to verify a Chinese supplier (2026) (sourcing agent characteristics: same province, bilingual, transparent fees of 3–10% of order, references from other foreign buyers)', publisher: 'China With Me', href: 'https://chinawithme.com/guides/verify-chinese-supplier', accessed: '2026-09-05' },
 { title: 'Is Alibaba legit? 2026 guide (sourcing agents maintaining relationships with verified manufacturers; physical facility inspection; payments through established business channels rather than direct wires)', publisher: 'Yakkyofy', href: 'https://yakkyofy.com/is-alibaba-legit/', accessed: '2026-09-05' },
 { title: 'Amazon FBA freight forwarder China: complete guide (consolidation of goods from multiple suppliers into a single shipment)', publisher: 'FBA Freight', href: 'https://freightfba.com/amazon-fba-freight-forwarder-china/', accessed: '2026-09-05' },
]} />
