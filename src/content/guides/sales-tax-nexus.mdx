...
seoTitle: "Sales Tax After Marketplace Facilitator Laws: What Is Still Yours"
...
<Figure value="Sales tax only" kind="cost" source="Eightx and Sam Brotman, 2026 analyses of marketplace facilitator scope, checked September 5, 2026">
 The scope of marketplace facilitator laws. Income, franchise and gross-receipts tax arising from FBA inventory are remaining entirely with the seller.
</Figure>
...
<Faq items={[
 ...
 { q: "Does FBA create nexus?", a: "FBA inventory creates physical nexus in every state where it is stored, regardless of revenue — even one pallet — and that the economic threshold does not protect against it." },
 { q: "Do I still have to register in states where Amazon collects?", a: "many states still require registration and filing, including zero-dollar or marketplace-deduction returns, even where the marketplace collects all the tax." },
 { q: "Do my Amazon sales count toward economic nexus?", a: "several states count marketplace sales toward the economic nexus total. You can cross a threshold on Amazon volume and owe a registration for your direct sales without noticing." },
 { q: "What about income tax?", a: "income, franchise and gross-receipts tax arising from FBA inventory as entirely the seller's responsibility, in the roughly 40 states that levy them, and states that FBA sellers routinely overlook this." },
