...
<Steps title="Four layers on the same pallet" accent={1} source="Current per-cubic-foot rates and dates: the tables below"
  steps={[
    { t: 'Monthly base', d: 'always on' },
    { t: 'Q4 step-up', d: 'Oct-Dec rates' },
    { t: 'Aged surcharge', d: 'scales with age' },
    { t: 'Utilization', d: 'ratio-based' },
  ]} />
