...
<Figure value="Rejected" kind="cost" source="CBP guidance on de minimis suspension, reported by GHY International, accessed 8 August 2026">
...
<Figure value="1 Jul 2027" kind="cost" source="One Big Beautiful Bill Act of 2025, as reported by Avalara, accessed 8 August 2026">
...
<Faq items={[
  ...
  { q: "Do I need a customs bond now?", a: "For formal entries, effectively yes. Reporting also indicates CBP may require a bond on informal entries at or below $2,500. Confirm your position with a licensed broker rather than assuming." },
  ...
  { q: "Is this the final state of the rules?", a: "No. Congress repealed Section 321 for commercial shipments effective 1 July 2027, and CBP's Entry Type 13 mail test begins 22 September 2026. Treat current arrangements as transitional." },
]} />

<Sources items={[
  { title: 'The end of de minimis: new US entry processes (Type 11, Type 01, Type 13 test, Section 321 repeal effective 1 July 2027)', publisher: 'Avalara', href: 'https://www.avalara.com/blog/en/north-america/2024/11/de-minimis-exemption-changes-coming.html', accessed: '2026-08-08' },
  { title: 'US to end de minimis exemption for low-value imports (ACE rejects Type 86 cargo release; manifest option removed)', publisher: 'GHY International', href: 'https://www.ghy.com/trade-compliance/us-to-end-de-minimis-exemption-for-low-value-imports-on-august-29/', accessed: '2026-08-08' },
  { title: 'US de minimis exemption for commercial goods ends (bond on informal entries; postal per-package bands $80 / $160 / $200)', publisher: 'BorderBuddy', href: 'https://borderbuddy.com/trade-tariff-news/u-s-de-minimus-exemption-for-commercial-goods-ends', accessed: '2026-08-08' },
  { title: 'Type 11, the new Section 321 (consolidated informal entry from manifest data; bond requirement)', publisher: 'Jet Worldwide', href: 'https://www.jetworldwide.com/blog/type-11..-the-new-section-321', accessed: '2026-08-08' },
  { title: 'Test concerning entry of Section 321 low-value shipments through ACE (Entry Type 86), republication with modifications', publisher: 'Federal Register', href: 'https://www.federalregister.gov/documents/2024/01/16/2024-00698/test-concerning-entry-of-section-321-low-value-shipments-through-the-automated-commercial', accessed: '2026-08-08' },
  { title: 'Entry of low-value shipments (background on the Section 321 Data Pilot and Entry Type 86 Test)', publisher: 'Federal Register', href: 'https://www.federalregister.gov/documents/2025/01/14/2025-00551/entry-of-low-value-shipments', accessed: '2026-08-08' },
]} />
