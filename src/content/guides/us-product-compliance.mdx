---
title: "From 8 July 2026, CPSC certificates are filed electronically at the border. That changes who finds out first."
...
minutes: 11
numbered: true
ledger: "CPSC eFile at the border from 8 July 2026"
ledgerKind: "cost"
draft: false
---
...
<Figure value="8 July 2026" kind="cost" source="CPSC, Children's Product Certificate business guidance, accessed 8 August 2026">
...
<Faq items={[
  { q: "What changed on 8 July 2026?", a: "CPSC states that importers of most regulated consumer products must electronically file certificates of compliance with CBP via a Partner Government Agency message set from that date. Amazon published parallel guidance for sellers." },
  ...
  { q: "How long does Amazon give me to produce a certificate?", a: "Reporting describes a window of around 72 hours, with ASIN suspension as the consequence of missing it. That is retrieval time, not testing time." },
  { q: "Does Proposition 65 apply to me if I am not in California?", a: "It applies to products sold or shipped into California. Reporting describes Amazon preventing non-compliant products from shipping there, which given California's share of US volume is a material restriction." },
...
<Sources items={[
  { title: 'Children\u2019s Product Certificate (eFiling of certificates of compliance with CBP via a PGA message set beginning 8 July 2026; definition of a children\u2019s product; third-party testing requirement)', publisher: 'CPSC', href: 'https://www.cpsc.gov/Business--Manufacturing/Testing-Certification/Childrens-Product-Certificate', accessed: '2026-08-08' },
  { title: 'File CPSC certificates electronically starting July 8, 2026', publisher: 'Amazon Seller Central', href: 'https://sellercentral.amazon.com/help/hub/reference/external/GWCJUJ9WUZNRYVGN', accessed: '2026-08-08' },
  { title: 'Amazon compliance requirements 2026: full checklist (CPC and GCC contents; roughly 72-hour production window and ASIN suspension; Prop 65 covering 900+ substances; poly bag 1.5 mil minimum; launch checklist)', publisher: '365 Prep Center', href: 'https://365prepcenter.com/blog/amazon-compliance-requirements-2026-full-checklist-every-seller-needs-6/', accessed: '2026-08-08' },
  { title: 'Amazon product compliance requirements in the United States (CPC and test report from a CPSC-accepted lab; 19 CFR Part 134 country of origin marking; Amazon preventing Prop 65 non-compliant products shipping to California; sellers not determining children\u2019s product status)', publisher: 'Compliance Gate', href: 'https://www.compliancegate.com/amazon-united-states-product-compliance/', accessed: '2026-08-08' },
  { title: 'CPSC finds Amazon responsible for hazardous products sold by third-party sellers (July 2024 determination regarding the Fulfilled by Amazon programme; regulatory focus on platform responsibility)', publisher: 'Holland & Knight, via JD Supra', href: 'https://www.jdsupra.com/topics/product-recalls/online-marketplace/', accessed: '2026-08-08' },
]} />
