...
<Figure value="4 values" kind="cost" source="Review of 2026 customs fee guides, August 2026">
...
## Where the cap changes behaviour
...
6. **Per-shipment costs.** Broker fee, ISF if ocean, bond amortised across the year's entries.
...
<Faq items={[
  ...
  { q: "Which MPF figure should I use for informal entries?", a: "Published sources give $1.16, $2.49, $2.69 and $2.72 within months of each other. Verify against the current CBP fee schedule or a recent entry summary before modelling — this guide will not pick one for you." },
  ...
  { q: "Do these fees change?", a: "Yes, annually. The user fees carry an inflation adjustment effective 1 October each year, which is a large part of why published rate cards disagree." },
]} />

<Sources items={[
  { title: 'MPF & HMF customs fees: 2026 rates, caps and who pays (0.3464%; max $634.62; min $32.71; informal $2.49 manual / $1.16 electronic; HMF 0.125%)', publisher: 'Peacock Tariff Consulting', href: 'https://www.peacocktariffconsulting.com/mpf-hmf-fees-explained/', accessed: '2026-08-08' },
  { title: 'MPF fee guide 2026: rates and exemptions (0.3464%; min $33.58; max $651.50; informal automated $2.69; manual up to $12.09; effective 1 Oct 2025)', publisher: 'FreightAmigo', href: 'https://www.freightamigo.com/en/blog/logistics/understanding-the-merchandise-processing-fee-mpf-in-2026-rates-exemptions-and-importer-strategies/', accessed: '2026-08-08' },
  { title: 'US customs user fees explained: MPF, HMF, COBRA and APHIS rates for 2026 (fees calculated on entered value, not on the duty; FY2026 adjustments)', publisher: 'FreightFigures', href: 'https://www.freightfigures.com/articles/us-customs-user-fees-mpf-hmf-2026', accessed: '2026-08-08' },
  { title: 'Import duty from China to USA: every tariff, rate and fee (informal MPF $2.72; ISF and broker fee ranges; continuous bond sizing)', publisher: 'GingerControl', href: 'https://gingercontrol.com/blog/importing-from-china-tariff-guide', accessed: '2026-08-08' },
]} />
